...
class Google():
    ...
    def access_google(self):
        ...
        try:
            ...
            #<button id="VnjCcb" class="tHlp8d" data-ved="0ahUKEwis_e2O7o_2AhVFolwKHZBSBhcQiJAHCB4"><div class="QS5gu sy4vM" role="none">Customise</div>
            act_on_element('//button[child::div[text()="Customise"]]', "click_element")
