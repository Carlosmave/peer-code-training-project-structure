...
class Mundialitis():
    ...
    def register_new_user(self):
        ...
        self.browser.input_text_when_element_is_visible('//input[@id="rfirstname"]', "RPA")
        self.browser.input_text_when_element_is_visible('//input[@id="rlastname"]', "TRAINING")
        self.browser.input_text_when_element_is_visible('//input[@id="remail"]', "rpa@training.com")
        self.browser.input_text_when_element_is_visible('//input[@id="raddress"]', "RPA TRAINING ADDRESS")
